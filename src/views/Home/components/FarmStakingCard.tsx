  ...
  return (
    <StyledFarmStakingCard>
      <CardBody>
        ...
        <CardImage src="/images/egg/cheese.png" alt="cake logo" width={100} height={64} />
        <Block>
          <Label>{TranslateString(544, 'XVMC to Harvest')}</Label>
          <CakeHarvestBalance earningsSum={earningsSum}/>
          <Label>~${(eggPrice * earningsSum).toFixed(2)}</Label>
        </Block>
        <Block>
          <Label>{TranslateString(546, 'XVMC in Wallet')}</Label>
