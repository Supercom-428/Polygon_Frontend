  ...
  const farmsList = useCallback(
    (farmsToDisplay, removed: boolean) => {
      ...
      const farmsToDisplayWithAPY: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        console.log("###cakeRewardPerBlock = ", cakeRewardPerBlock.toNumber(), "BLOCKS_PER_YEAR = ", BLOCKS_PER_YEAR.toNumber(), "cakeRewardPerYear = ", cakeRewardPerYear.toNumber())
        console.log("###cakePrice = ", cakePrice.toNumber(), "apy = ", apy.toNumber())
  ...
  return (
    <Page>
      <Heading as="h1" size="lg" color="primary" mb="50px" style={{ textAlign: 'center' }}>
        {
          tokenMode ?
            'Stake tokens to earn XVMC'
            :
          'Stake LP tokens to earn XVMC'
        }
      </Heading>
      {/* <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
        50% of the Deposit Fee will be used to buyback XVMC and Burn the Tokens
      </Heading>
      <Heading as="h2" color="secondary" mb="50px" style={{ textAlign: 'center' }}>
      ...
      <div>
        ...
        <FlexLayout>
          <Route exact path={`${path}`}>
            ...
            {stakedOnly ? farmsList(stakedOnlyFarms, true) : farmsList(activeFarms, true)}
          </Route>
